...
Prenons un exemple de sac contenant 1000 boules blanches et noires. On en tire 6 au hasard. On veut tester l'hypothèse qu'il y a 500 blanches et 500 noires: $H_0$: $\mathbb{P}(blanche) = 0,5$ *vs* $H_A$: $\mathbb{P}(blanche) ≠ 0,5$.
